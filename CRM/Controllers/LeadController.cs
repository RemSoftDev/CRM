...
namespace CRM.Controllers
{
	...
	public class LeadController : BaseController
	{
		...
		private readonly IEmailIgnoreNotifierManger _emailIgnoreNotifierManger;
		...
		public LeadController(
			...
			IEmailIgnoreNotifierManger emailIgnoreNotifierManger)
			: base(unitOfWork)
		{
			_leadConvertService = leadConvertService;
			_leadManager = leadManager;
			_emailService = emailService;
			_emailIgnoreNotifierManger = emailIgnoreNotifierManger;
		}
		...
		public ActionResult Edit(int id, bool? isFromPopUp)
		{
			if (isFromPopUp == true)
			{
