namespace CRM.Report
{
	partial class CustomerReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.CustomerSource = new Telerik.Reporting.ObjectDataSource();
			...
			// textBox1
			// 
			this.textBox1.Location = new Telerik.Reporting.Drawing.PointU(Telerik.Reporting.Drawing.Unit.Inch(2.6000001430511475D), Telerik.Reporting.Drawing.Unit.Inch(0.29999998211860657D));
			...
			this.textBox1.Value = "Customer Report";
			// 
			// textBox4
			// 
			...
			// CustomerSource
			// 
			this.CustomerSource.DataMember = "GetCustomer";
			this.CustomerSource.DataSource = typeof(CRM.Report.CustomerSource);
			this.CustomerSource.Name = "CustomerSource";
			// 
			// CustomerReport
			// 
			this.DataSource = this.CustomerSource;
		...
		private Telerik.Reporting.ObjectDataSource CustomerSource;
